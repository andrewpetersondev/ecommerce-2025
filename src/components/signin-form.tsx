// Define props for the SigninForm
import React, { useEffect, useRef } from "react";

interface SigninFormProps {
  focusEmailOnLoad?: boolean; // Optionally focus the email input on load
}

export const SigninForm: React.FC<SigninFormProps> = ({
  focusEmailOnLoad = false,
}) => {
  const emailInputRef = useRef<HTMLInputElement | null>(null);
  // Automatically focus the email input if the option is true
  useEffect(() => {
    if (focusEmailOnLoad) {
      ...
      <div>
        ...
        <div className="mt-2">
          <input
            ...
            autoComplete="email"
            ref={emailInputRef}
            placeholder="person@earth.planet"
